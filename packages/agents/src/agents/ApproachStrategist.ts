...
const FALLBACK_SYSTEM = `Ты выбираешь угол захода для CustDev-приглашения автору канала или менеджеру канала. Цель — короткое исследовательское интервью по продукту. НЕ продажа, НЕ реклама.
