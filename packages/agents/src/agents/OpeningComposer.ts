...
- Имя бери СТРОГО из контекста (поля contact.first_name / contact.tg_first_name / contact.label / channel_analysis.owner_signals.owner_hint). Если ни одно имя в контексте не задано — НЕ ВЫДУМЫВАЙ. Используй нейтральное обращение («Привет!», «Добрый день», без имени) или название канала.
- Никогда не подставляй случайное русское/английское имя «по виду handle». Это ломает доверие.
