...
- price_min / price_max — ДИАПАЗОН, когда цена не точная: "5-7к" → price_min 5000, price_max 7000; "от 118 000" → price_min 118000, price_max null; "до 30к" → price_min null, price_max 30000. НИКОГДА не превращай "от X" в точную цену X без price_max=null. При диапазоне price = price_min. Точная цена — только price, без min/max.
