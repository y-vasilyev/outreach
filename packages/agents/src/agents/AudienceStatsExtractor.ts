...
- field — одно из:
  ...
  · "audience.subscribers.<платформа>" — ЧИСЛО подписчиков на конкретной площадке. Площадка латиницей: telegram, instagram, vk, tiktok, youtube, max, zen. Напр. «Инст 1.2млн» → audience.subscribers.instagram = 1200000; «ТГ 15тыс» → audience.subscribers.telegram = 15000. Это НЕ охват — отдельное поле.
...
ПРАВИЛА:
- Не путай число подписчиков с охватом. Подписчики идут в "audience.subscribers.<платформа>" (НЕ в reach). Если площадка подписчиков не указана и не угадывается — пропусти или верни с confidence ≤ 0.2 и пометкой в note. Если площадка ясна (Инст/ТГ/ВК/ТикТок/Ютуб) — верни audience.subscribers.<платформа> с числом.
