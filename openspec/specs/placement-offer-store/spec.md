# placement-offer-store Specification

## Purpose
TBD - created by archiving change placement-offer-table. Update Purpose after archive.
## Requirements
